<div class="mb-10 w-full p-10 rounded-2xl bg-gray-100  dark:bg-slate-800">
  <div class="flex items-center">
    <div class="flex-1 px-1 mx-1 flex cursor-pointer items-center">
      ...
      <span class=" font-bold text-yellow-600 text-2xl"> PickForest </span>
    </div>
    <div
      on:click={() => (window.location.href = "https://instagram.com/2coderzz")}
      class="ml-auto dark:bg-slate-300 rounded-lg "
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
