      ...
      <form class="mt-6" on:submit|preventDefault={login}>
        <div>
          ...
          <input
            ...
            class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-yellow-500 dark:text-black focus:bg-white focus:outline-none"
            autocomplete
            required
            bind:value={email}
          />
        ...
        <div class="mt-4">
          ...
          <input
            ...
            minlength="6"
            class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border dark:text-black focus:border-yellow-500
        ...
        <div class="text-right mt-2">
          <a
            href="#"
            class="text-sm dark:text-white font-semibold text-gray-700 hover:text-yellow-700 focus:text-yellow-700"
            >Forgot Password?</a
          >
        </div>
