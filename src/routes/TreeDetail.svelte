...
<section class=" h-full  flex  flex-col  p-5 pt-2.5 lg:p-10 lg:pt-5 ">
  <div class=" px-1   flex items-center">
    ...
    <span class=" font-bold text-2xl "> PickForest </span>
  ...
  <div class="relative flex-col flex justify-center items-center mt-10 lg:m-10">
    ...
    <div class="avatar absolute m-auto lg:-bottom-24 -bottom-20  ">
      <div class="mb-8 lg:w-32 lg:h-32 h-24 w-24 mask mask-squircle shadow-xl">
    ...
    <div class="p-5  lg:max-w-screen-lg w-full flex flex-col rounded-2xl ">
      ...
      <div class="flex flex-col gap-4">
        {#if data.trees.length === 0}
          <div
            class="w-full rounded-2xl grid place-items-center p-10 font-bold text-xl dark:bg-slate-800 bg-slate-200"
          >
            {data.name} has no trees yet 😕
          </div>
        {:else}
    ...
    >
      <div class="p-5 bg-yellow-200 rounded-2xl mx-auto  max-w-prose">
        ...
        <div class="opacity-50 mb-5 newfont text-black">
          Have you been in a situation where you are tryna post something on
          your social account but you are in distress as to which of the 178
          pictures to post? (Trust me, been there)
        </div>
